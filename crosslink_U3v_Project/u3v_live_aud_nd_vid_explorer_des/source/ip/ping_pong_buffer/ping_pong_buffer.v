...
/* Module Version: 5.1 */
/* C:\tools\lattice\diamond\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n ping_pong_buffer -lang verilog -synth lse -bus_exp 7 -bb -arch sn5w00 -type ebfifo -sync_mode -depth 1024 -width 16 -regout -no_enable -pe 50 -pe2 51 -pf 1000 -sync_reset -fill -fdc C:/work/cypress/sx3/designs/gitlab/explorer_kit/sx3_live_aud_vga_vid_explorer_fpga_des/source/ip/ping_pong_buffer/ping_pong_buffer.fdc  */
/* Tue Jul 13 10:52:23 2021 */


`timescale 1 ns / 1 ps
module ping_pong_buffer (Data, Clock, WrEn, RdEn, Reset, Q, WCNT, Empty, 
    Full, AlmostEmpty, AlmostFull)/* synthesis NGD_DRC_MASK=1 */;
    ...
    DP8KE pdp_ram_0_0_1 (.DIA8(Data[8]), .DIA7(Data[7]), .DIA6(Data[6]), 
        ...
        .DIA1(Data[1]), .DIA0(Data[0]), .ADA12(wcount_9), .ADA11(wcount_8), 
        .ADA10(wcount_7), .ADA9(wcount_6), .ADA8(wcount_5), .ADA7(wcount_4), 
        .ADA6(wcount_3), .ADA5(wcount_2), .ADA4(wcount_1), .ADA3(wcount_0), 
        .ADA2(scuba_vlo), .ADA1(scuba_vlo), .ADA0(scuba_vhi), .CEA(wren_i), 
        .OCEA(wren_i), .CLKA(Clock), .WEA(scuba_vhi), .CSA2(scuba_vlo), 
        ...
        .ADB12(rcount_9), .ADB11(rcount_8), .ADB10(rcount_7), .ADB9(rcount_6), 
        .ADB8(rcount_5), .ADB7(rcount_4), .ADB6(rcount_3), .ADB5(rcount_2), 
        .ADB4(rcount_1), .ADB3(rcount_0), .ADB2(scuba_vlo), .ADB1(scuba_vlo), 
        ...
        .DOB0(Q[0]))
             /* synthesis MEM_LPC_FILE="ping_pong_buffer.lpc" */
    ...
    DP8KE pdp_ram_0_1_0 (.DIA8(scuba_vlo), .DIA7(scuba_vlo), .DIA6(Data[15]), 
        ...
        .DIA1(Data[10]), .DIA0(Data[9]), .ADA12(wcount_9), .ADA11(wcount_8), 
        .ADA10(wcount_7), .ADA9(wcount_6), .ADA8(wcount_5), .ADA7(wcount_4), 
        .ADA6(wcount_3), .ADA5(wcount_2), .ADA4(wcount_1), .ADA3(wcount_0), 
        .ADA2(scuba_vlo), .ADA1(scuba_vlo), .ADA0(scuba_vhi), .CEA(wren_i), 
        .OCEA(wren_i), .CLKA(Clock), .WEA(scuba_vhi), .CSA2(scuba_vlo), 
    ...
    FD1P3DX FF_36 (.D(ifcount_0), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_0))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_35 (.D(ifcount_1), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_1))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_34 (.D(ifcount_2), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_2))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_33 (.D(ifcount_3), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_3))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_32 (.D(ifcount_4), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_4))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_31 (.D(ifcount_5), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_5))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_30 (.D(ifcount_6), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_6))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_29 (.D(ifcount_7), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_7))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_28 (.D(ifcount_8), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_8))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_27 (.D(ifcount_9), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_9))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_26 (.D(ifcount_10), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_10))
             /* synthesis GSR="ENABLED" */;
    ...
    CCU2C ae_set_cmp_1 (.A0(scuba_vlo), .A1(scuba_vlo), .B0(fcount_2), .B1(fcount_3), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C ae_set_cmp_2 (.A0(scuba_vhi), .A1(scuba_vhi), .B0(fcount_4), .B1(fcount_5), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C ae_set_cmp_5 (.A0(scuba_vlo), .A1(scuba_vlo), .B0(fcount_10), 
    ...
    CCU2C ae_clr_cmp_0 (.A0(fcnt_en_inv), .A1(r_nw_inv), .B0(fcount_0), 
        .B1(fcount_1), .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C ae_clr_cmp_1 (.A0(r_nw), .A1(scuba_vlo), .B0(fcount_2), .B1(fcount_3), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C ae_clr_cmp_2 (.A0(scuba_vhi), .A1(scuba_vhi), .B0(fcount_4), .B1(fcount_5), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C ae_clr_cmp_5 (.A0(scuba_vlo), .A1(scuba_vlo), .B0(fcount_10), 
        .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), 
        .D1(scuba_vhi), .CIN(co4_6), .S0(), .S1(), .COUT(ae_clr_d_c));
    ...
    CCU2C af_cmp_4 (.A0(fcount_8), .A1(fcount_9), .B0(scuba_vhi), .B1(scuba_vhi), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co3_7), .S0(), .S1(), .COUT(co4_7));
    ...
    CCU2C af_cmp_5 (.A0(fcount_10), .A1(scuba_vlo), .B0(scuba_vlo), .B1(scuba_vlo), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co4_7), .S0(), .S1(), .COUT(af_d_c));
    ...
    // exemplar begin
    // exemplar attribute pdp_ram_0_0_1 MEM_LPC_FILE ping_pong_buffer.lpc
    // exemplar attribute pdp_ram_0_0_1 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_1_0 MEM_LPC_FILE ping_pong_buffer.lpc
