...
/* Module Version: 5.7 */
/* C:\tools\lattice\diamond\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n vga_pll -lang verilog -synth lse -bus_exp 7 -bb -arch sn5w00 -type pll -fin 16 -fclkop 16 -fclkop_tol 0.0 -fclkos 166.4 -fclkos_tol 0.0 -phases 0 -phase_cntl STATIC -lock -fb_mode 1 -fdc C:/work/cypress/sx3/designs/gitlab/explorer_kit/sx3_live_aud_vga_vid_explorer_fpga_des/source/ip/vga_pll/vga_pll.fdc  */
/* Thu Jul 08 20:00:15 2021 */


`timescale 1 ns / 1 ps
module vga_pll (CLKI, CLKOP, CLKOS, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    output wire LOCK;
    ...
    EHXPLLM PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .CLKOS3(), .LOCK(LOCK), .INTLOCK(), .REFCLK(REFCLK), .CLKINTFB())
             /* synthesis FREQUENCY_PIN_CLKOS="166.400000" */
             /* synthesis FREQUENCY_PIN_CLKOP="16.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 166.400000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 16.000000
