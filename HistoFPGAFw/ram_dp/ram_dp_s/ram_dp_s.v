...
/* Module Version: 6.5 */
/* C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n ram_dp_s -lang verilog -synth lse -bus_exp 7 -bb -arch sn5w00 -type bram -wp 10 -rp 0011 -rdata_width 24 -data_width 24 -num_rows 1024 -cascade -1 -mem_init0 -fdc C:/Users/ethanhead/Desktop/gen3-cam-fw/HistoFPGAFw/ram_dp/ram_dp_s/ram_dp_s.fdc  */
...
module ram_dp_s (WrAddress, RdAddress, Data, WE, RdClock, RdClockEn, 
    ...
    DP8KE ram_dp_s_0_0_2 (.DIA8(Data[8]), .DIA7(Data[7]), .DIA6(Data[6]), 
        ...
        .DOB1(Q[1]), .DOB0(Q[0]))
             /* synthesis MEM_LPC_FILE="ram_dp_s.lpc" */
    ...
    DP8KE ram_dp_s_0_1_1 (.DIA8(Data[17]), .DIA7(Data[16]), .DIA6(Data[15]), 
    ...
    DP8KE ram_dp_s_0_2_0 (.DIA8(scuba_vlo), .DIA7(scuba_vlo), .DIA6(scuba_vlo), 
    ...
    // exemplar begin
    // exemplar attribute ram_dp_s_0_0_2 MEM_LPC_FILE ram_dp_s.lpc
    // exemplar attribute ram_dp_s_0_0_2 MEM_INIT_FILE INIT_ALL_0s
    // exemplar attribute ram_dp_s_0_1_1 MEM_LPC_FILE ram_dp_s.lpc
    // exemplar attribute ram_dp_s_0_1_1 MEM_INIT_FILE INIT_ALL_0s
    // exemplar attribute ram_dp_s_0_2_0 MEM_LPC_FILE ram_dp_s.lpc
    // exemplar attribute ram_dp_s_0_2_0 MEM_INIT_FILE INIT_ALL_0s
    // exemplar end
